...
## Project Structure
    ...
    ├── testapiautoconnecto_60650  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_60650`
...
2. Clone this repo and `cd testapiautoconnecto_60650`
